...
This section describes how to setup a repository on GitHub so readers can make suggestions regarding terms and definitions. The repository can also allow collaboration. For example, professors can get their students to assist in compiling definitions for the glossary. 

1. We suggest referring to [Happy Git](http://happygitwithr.com/new-github-first.html) to get started on setting up GitHub and linking it to R Studio.
2. Once you have done so, you can store and update your glossary project on GitHub. 
3. Through the repository, readers can create an issue to make suggestions.
